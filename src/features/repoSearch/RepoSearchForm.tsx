...
import FormStyles from './pure-forms.css'
import BtnStyles from './pure-button.less'
...
export const RepoSearchForm = ({
  ...
  return (
    <form className={FormStyles["pure-form"]}>
      <div>
        ...
        <button
          type="button"
          className={classnames(BtnStyles["pure-button"], BtnStyles["pure-button-primary"])}
          style={{ marginLeft: 5 }}
